...
public class CombatController : MonoBehaviour
{
    ...
    public float defense = 0;                      //defense of the player, reduces damage taken
    public float luck = 10;                        //luck of the player, chance for critical hits
    public float critMult = 2f;                    //multiplier for critical hits
